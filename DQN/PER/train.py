...
def get_loss(memory, main_net, target_net):
    ...
    batch_r = torch.Tensor(memory[:, state_dim + 1]).reshape(-1, 1)
...
if __name__ == '__main__':
    ...
    writer = SummaryWriter(log_dir='runs/DDQN (no PER)')
    ...
    while global_episode <= MAX_EPISODE:
        ...
        while True:
            ...
            if global_episode % 10 == 0 and RENDER:
                env.render()
